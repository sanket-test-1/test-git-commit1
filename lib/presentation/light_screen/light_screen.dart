import '../light_screen/widgets/light_item_widget.dart';
...
class LightScreen extends GetWidget<LightController> {
  @override
                                                              ...
                                                              child: Row(
                                                                  ...
                                                                  children: [
                                                                    CustomIconButton(
                                                                        ...
                                                                        child: CommonImageView(
                                                                            svgPath:
                                                                                ImageConstant.imgLightbulb63X63)),
                                                                    CustomIconButton(
                                                                        height:
                                                                            63,
                                                                        width:
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                          Padding(
                                                                              ...
                                                                              child: Text("lbl_demons".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsSemiBold12.copyWith(letterSpacing: 0.12))),
                                                                          Padding(
                                                                              padding: getPadding(top: 9),
                                                                              child: Text("lbl_alec_benjamin".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsRegular14Gray90090.copyWith(letterSpacing: 0.14)))
                                                                        ]))
                                                              ])),
                                                      CustomIconButton(
                                                          height: 18,
